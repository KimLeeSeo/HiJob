...
function SimplePost({title,author,time,count,like,reply,content}){
   
    return(
        <>
        <Link to="/cummunity_post" state={{title,author,time,count,like,reply,content}} style={{textDecoration:"none", color:"black"}}>
